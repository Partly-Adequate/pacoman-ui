...
-- images and icons
local ic_setting = Material("vgui/pacoman_ui/ic_setting")
local ic_namespace = Material("vgui/pacoman_ui/ic_namespace")
local ic_add = Material("vgui/pacoman_ui/ic_add")
local ic_remove = Material("vgui/pacoman_ui/ic_remove")
